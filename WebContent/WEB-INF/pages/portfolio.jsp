...
<div>
    <script type="text/ng-template" id="buyContent.html">
        ...
        <div class="modal-body" style="font-size:15px;">
			...
			<b style="font-family: 'Times New Roman', cursive; font-size:25px;"> {{buyItem.price}}</b>
			<br/>
                        			...
                        			<div class="col-lg-6">
                            			<section class="panel">
                                			...
                                			<div class="panel-body text-center" ng-controller="PieCtrl">
                												<canvas id="doughnut" class="chart chart-doughnut" chart-data="data" chart-labels="labels" chart-legend="true"></canvas> 
                                			</div>
                            			</section>
                        			</div>   
