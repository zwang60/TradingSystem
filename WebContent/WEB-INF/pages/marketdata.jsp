                           ...
                           <tbody>
                              ...
                              <tr ng-repeat="stock in stockInfo | orderBy:predicate:reverse | filter:stock.symbol track by $index">
								...
								<b ng-if="stock.change>0" highlighter="stock.price" >&#36{{stock.price| number:2}}</b>
					     		...
					     		<td >
									<b ng-if="stock.change>0"  style="color:green">&#36+{{stock.change| number:2}} <span class="glyphicon glyphicon-arrow-up"></span></b>
									<b ng-if="stock.change<0"  style="color:red">&#36{{stock.change| number:2}} <span class="glyphicon glyphicon-arrow-down"></span></b>
									<b ng-if="stock.change==0" style="color:black">&#36{{stock.change| number:2}}</b>
								</td>
								<td >
...
<div>
    <script type="text/ng-template" id="buyContent.html">
        ...
        <div class="modal-body" style="font-size:15px;">
            <label>Stock Symbol:  </label>
			<b style=" font-family: 'Times New Roman', cursive; font-size:25px;"> {{buyItem.stock.symbol}}</b>
			<br/>
			<label>Stock Name:  </label>
			<b style=" font-family: 'Times New Roman', cursive; font-size:25px;"> {{buyItem.stockName}}</b>
			<br/>
			<label>Unit Price:  </label>
			<b style="font-family: 'Times New Roman', cursive; font-size:25px;"> &#36{{buyItem.price}}</b>
			<br/>
    ...
    <script type="text/ng-template" id="sellContent.html">
        ...
        <div class="modal-body" style="font-size:15px;">
            <label>Stock Symbol: </label>
			<b style=" font-family: 'Times New Roman', cursive; font-size:25px;">{{sellItem.stock.symbol}}</b><br/>
			<label>Stock Name: </label>
			<b style=" font-family: 'Times New Roman', cursive; font-size:25px;">{{sellItem.stockName}}</b><br/>
			<label>Unit Price: </label>
			<b style=" font-family: 'Times New Roman', cursive; font-size:25px;">{{sellItem.price}}</b><br/>
			<label>Currently Own: </label>
			<b style=" font-family: 'Times New Roman', cursive; font-size:25px;">{{getAmount(sellItem)}}</b><br/>
			<label>Quantity: </label>
